      ...
      <nav id="main_sidebar" className={"main_sidebar " + (this.props.toggleSideBar ? 'toggled' : '')}>
        ...
        <div className="sidebar-content">
          ...
          <ul className="sidebar-nav">
            ...
            <div className="sidebar-user related-links">
              <div className="font-weight-bold dashboard">Related Links</div>
            </div>
            ...
            <li className="sidebar-item"><a href="https://www.covidvisualizer.com/" target="_blank" className="links">COVID-19 Visualizer</a></li>
            <li className="sidebar-item"><a href="https://www.covid19india.org/" target="_blank" className="links">COVID-19 India Tracker</a></li>
          </ul>
        </div>
      </nav>
    )
